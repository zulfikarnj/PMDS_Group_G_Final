...
def home():
    ...
    data['WeekCasePerMil'] = [float(request.form['WeekCasePerMil'])]
    data['WeekDeath'] = [int(request.form['WeekDeath'])]
    data['WeekDeathPerMil'] = [float(request.form['WeekDeathPerMil'])]
    ...
    data['TotalVacPerHun'] = [float(request.form['TotalVacPerHun'])]
    data['PeopelVacPerHun'] = [float(request.form['PeopleVacPerHun'])]
    data['PeopleFullVacPerHun'] = [float(request.form['PeopleFullVacPerHun'])]
    data['TotalBoostPerHun'] = [float(request.form['TotalBoostPerHun'])]
    data['DailyVacPerHun'] = [float(request.form['DailyVacPerHun'])]
    data['DailyPeopleVac'] = [int(request.form['DailyPeopleVac'])]
    data['DailyPeopleVacPerHun'] = [float(request.form['DailyPeopleVacPerHun'])]
